...
function RenderCard({item, isLoading, errMess}) {   //extract the item, whether it be props.dish, props.promo or props.leader
    if (isLoading) {
        return (
            <Loading />
        );
        ...
        return (    //cool animation; fades and transforms
