...
class Contact extends Component {
    ...
    //     return errors;
    // } not required, will be done by react-redux-form
                ...
                <div className='row row-content'>
                    ...
                    <div className='col-12 col-md-9'>
                        <Form model='feedback' onSubmit={(values) => this.handleSubmit(values)} resetOnSubmit={true}>
                            <Row className='form-group' /*label will occupy 2 cols for md-xl screens*/>
                                <Label htmlFor='firstname' md={2}>First Name</Label>
                                <Col md={10} /*this is like div classname="col-md-10"*/>
